...
const Signin = () => {
    ...
    // Main layout page are started from here , we use input as well as button tags
    return (
        <>
        <form className="bg-gray-200 flex flex-col py-12 px-8 rounded-lg w-8/12 md:w-6/12 mx-auto gap-10">
        <div className="flex items-center justify-center">
            <div
                className="bg-gray-400 border-[4px] border-blue-900 rounded-2xl hover:border-blue-500 transition-all duration-200"
            >
                <div
                ...
                >
                    ...
                    <p>
                        ...
                        <Link to="/signup" className="font-semibold text-white hover:text-blue-500 transition-all duration-200">Sign up</Link>
                    </p>
                </div>
            </div>
            <ToastContainer />
...
// for using signin page everywhere we export it.
